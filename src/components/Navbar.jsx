      ...
      <nav className="flex flex-col items-center px-6 py-4 bg-white shadow-md relative z-50">
        <div className="flex justify-between items-center w-full max-w-7xl">
          ...
          <div className="flex items-center gap-8 text-sm text-gray-700 flex-1 justify-end">
            ...
            >
              <button className="hover:text-pink-500 focus:outline-none font-semibold">Contact Us</button>
              {showContactInfo && (
       ...
       <div className="mt-6 fixed bottom-6 right-8 font=semi-bold">
          <button
            ...
            className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-6 px-6 rounded-full shadow-md transition-all duration-300 hover:scale-105"
          >
            Book a Demo Class
          </button>
        </div>
      ...
      {showDemoModal && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md relative animate-fadeIn">
            ...
            <h2 className="text-2xl font-bold text-pink-600 mb-4 text-center">Book a Demo Class</h2>
